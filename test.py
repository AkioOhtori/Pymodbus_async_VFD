...
test = ModbusClient("192.168.3.53")
test.connect()
d = test.read_coils(0, 8)
test.write_coils(16,1)  #NOTE: ADAM reg -1 because reasons
print(d.bits)
t = []
t = d.bits.copy()
print(t)
...
if __name__ == '__main__':
    dl_06 = Koyo('192.168.3.54')  # ip address goes here
    print(dl_06.dump)
    dl_06.disconnect()
    '''